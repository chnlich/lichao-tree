...
C++ implementations accompanying the paper *The Li-Chao Tree: Algorithm Specification and Analysis* ([doc/report.pdf](doc/report.pdf), [arXiv:2603.07948](https://arxiv.org/abs/2603.07948)).

## Overview

This repository provides optimized C++ implementations for maintaining the lower envelope of a set of linear functions (lines) $y = kx + m$, supporting efficient line insertion and point query operations. It includes the standard LICT, a line segment variant, and an iterative (ZKW) variant optimized for the $N = C$ regime.
...
- **ZKW LICT** (`zkw_lict.hpp`): Iterative, array-based variant optimized for DP problems where $N = C$. Eliminates recursion overhead and uses contiguous memory for better cache locality. Approximately 3x faster than standard LICT on all-on-hull workloads at $N = C = 10^7$ (3113 ms vs 9271 ms).
...
---
*See [doc/report.pdf](doc/report.pdf) or [arXiv:2603.07948](https://arxiv.org/abs/2603.07948) for the full paper.*
