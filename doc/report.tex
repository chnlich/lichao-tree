...
\begin{abstract}
The Li-Chao tree (LICT) was presented informally in a 2012 lecture context and has since gained widespread adoption within the competitive programming community. Despite over a decade of practical use and its inclusion in standard algorithm libraries, the structure has not been formally documented in the academic literature. This paper addresses that gap by providing precise algorithmic specifications, implementation details, and empirical performance analysis of the LICT. The LICT offers distinct advantages in implementation simplicity, numerical stability, and extensibility to advanced variants such as persistence and line segments.
\end{abstract}
