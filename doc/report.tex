...
\item \textbf{All on Hull:} Lines $y = -(i+1)x + (i+1)^2$ for $i \in [0, N-1]$. All $N$ lines contribute to the hull, since the slopes $-(i+1)$ are all distinct and any line with a unique slope appears on the lower envelope.
\end{itemize}
\end{itemize}
