...
Both operations must execute in logarithmic time---$O(\log n)$ for the Dynamic CHT and $O(\log C)$ for the LICT (where $C$ is the coordinate range)---to achieve acceptable performance for large-scale applications.
