...
\midrule
$10^5$ & int & LICT & 4.26 & 1.23 & 5.50 \\
$10^5$ & int & Dynamic CHT & 4.31 & 0.43 & 4.74 \\
$10^5$ & double & LICT & 5.11 & 1.57 & 6.67 \\
$10^5$ & double & Dynamic CHT & 3.19 & 0.52 & 3.71 \\
\midrule
$10^6$ & int & LICT & 42.30 & 13.78 & 56.08 \\
$10^6$ & int & Dynamic CHT & 45.00 & 5.35 & 50.35 \\
$10^6$ & double & LICT & 52.21 & 16.16 & 68.37 \\
$10^6$ & double & Dynamic CHT & 34.03 & 5.76 & 39.79 \\
\bottomrule
\end{tabular}
\end{table}

Table~\ref{tab:floating-point} presents the performance comparison when using double-precision coefficients ($k$, $b$) with integer query coordinates ($x$). Both structures exhibit comparable performance between integer and floating-point configurations. For $N = 10^6$, the LICT requires 52.21 ms for insertions with doubles versus 42.30 ms with integers, showing a modest increase due to double-precision arithmetic operations. The Dynamic CHT shows similar behavior (34.03 ms for doubles versus 45.00 ms for integers).
