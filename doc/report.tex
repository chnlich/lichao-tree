...
\node[draw, rectangle, fill=red!10, minimum width=2.5cm] (r1) at (2.5,-2) {$[4, 8]$: $y=3x-8$};
...
\node[draw, rectangle, minimum width=2.5cm] (r2l) at (1.2,-4) {$[4, 6]$: $-$};
\node[draw, rectangle, minimum width=2.5cm] (r2r) at (3.8,-4) {$[6, 8]$: $-$};

% Edges with labels
\draw[->, thick] (root) -- (l1);
\draw[->, thick, red] (root) -- (r1) node[midway, above right, red] {store here};
\draw[->] (l1) -- (l2l);
\draw[->] (l1) -- (l2r);
\draw[->] (r1) -- (r2l);
\draw[->] (r1) -- (r2r);
...
$y=x$ gives 4, $y=3x-8$ gives 4.\\
Midpoints equal, so $y=x$ stays.\\
...
Store $y=3x-8$ here.\\
Recursion ends (no line to displace).
};
