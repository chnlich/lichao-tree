...
In this static universe setting, an iterative segment tree~\cite{zkw2005} implementation (often called ZKW segment tree) can be employed to eliminate recursion overhead and may improve cache locality due to its contiguous memory layout. We therefore include a third variant, \textbf{ZKW LICT}, in this comparison to evaluate the benefits of this specialized optimization against the standard LICT and Dynamic CHT.
