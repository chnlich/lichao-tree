...
% Tree structure
% Root node [0, 8]
\node[draw, rectangle, fill=blue!10, minimum width=2.5cm] (root) at (0,0) {$[0, 8]$: $y=x$};
\node[below=0.1cm of root] {\small $m=4$};

% Level 1 nodes
\node[draw, rectangle, fill=blue!10, minimum width=2.5cm] (l1) at (-2.5,-2) {$[0, 4]$: $y=2x$};
\node[below=0.1cm of l1] {\small $m=2$};
\node[draw, rectangle, fill=blue!10, minimum width=2.5cm] (r1) at (2.5,-2) {$[4, 8]$: $y=0.6x+2$};
\node[below=0.1cm of r1] {\small $m=6$};

% Level 2 nodes
\node[draw, rectangle, minimum width=2.5cm] (l2l) at (-3.8,-4) {$[0, 2]$: $-$};
\node[draw, rectangle, minimum width=2.5cm] (l2r) at (-1.2,-4) {$[2, 4]$: $-$};
\node[draw, rectangle, fill=red!10, minimum width=2.5cm] (r2l) at (1.2,-4) {$[4, 6]$: $y=0.5x+5$};
\node[below=0.1cm of r2l] {\small $m=5$};
\node[draw, rectangle, minimum width=2.5cm] (r2r) at (3.8,-4) {$[6, 8]$: $-$};

% Edges with labels
\draw[->, thick] (root) -- (l1);
\draw[->, thick, red] (root) -- (r1) node[midway, above right, red, font=\scriptsize] {route $L_{new}$};
\draw[->] (l1) -- (l2l);
\draw[->] (l1) -- (l2r);
\draw[->, thick, red] (r1) -- (r2l) node[midway, left, red, font=\scriptsize, xshift=-2pt] {route $L_{new}$};
\draw[->] (r1) -- (r2r);

% Explanation callouts - repositioned to avoid overlap
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west, fill=white, fill opacity=0.8, text opacity=1] at (4.8, 0) {
...
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west, fill=white, fill opacity=0.8, text opacity=1] at (4.8, -2.5) {
...
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west, fill=white, fill opacity=0.8, text opacity=1] at (4.8, -5.0) {
...
\end{tikzpicture}
\caption{Line Insertion Tree View. Inserting line $y=0.5x+5$. This example shows how a line is routed through multiple occupied nodes ($[0,8] \to [4,8] \to [4,6]$) based on midpoint comparisons until it finds an empty node or a better fit.}
...
% Level 1 nodes
\node[draw, rectangle, fill=green!10, minimum width=2.5cm] (l1) at (-2.5,-2) {$[0, 4]$: $y=2x$};
\node[below=0.1cm of l1] {\small $m=2$};
\node[draw, rectangle, fill=blue!10, minimum width=2.5cm] (r1) at (2.5,-2) {$[4, 8]$: $y=0.6x+2$};
\node[below=0.1cm of r1] {\small $m=6$};

% Level 2 nodes
\node[draw, rectangle, fill=yellow!20, minimum width=2.5cm] (l2l) at (-3.8,-4) {$[0, 2]$: $-$};
\node[draw, rectangle, minimum width=2.5cm] (l2r) at (-1.2,-4) {$[2, 4]$: $-$};
\node[draw, rectangle, fill=red!10, minimum width=2.5cm] (r2l) at (1.2,-4) {$[4, 6]$: $y=0.5x+5$};
\node[draw, rectangle, minimum width=2.5cm] (r2r) at (3.8,-4) {$[6, 8]$: $-$};

% Query path highlighted
\draw[->, very thick, blue] (root) -- (l1) node[midway, left] {$x=1 \le 4$};
\draw[->, very thick, blue] (l1) -- (l2l) node[midway, left] {$x=1 \le 2$};

% Result box
\node[draw, thick, fill=white, rounded corners, align=left] at (4.5, -2) {
...
\node[below=0.2cm of l2l, red, font=\bfseries] {Target $x=1$};
