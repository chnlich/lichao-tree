...
Figure~\ref{fig:insertion-example} illustrates the insertion of a new line $y=10$ into a structure already containing $y=x$ and $y=2x$.
...
\node[draw, rectangle, fill=red!10, minimum width=2.5cm] (r2l) at (1.2,-4) {$[4, 6]$: $y=10$};
\node[below=0.1cm of r2l] {\small $m=5$};
\node[draw, rectangle, minimum width=2.5cm] (r2r) at (3.8,-4) {$[6, 8]$: $-$};

% Edges with labels
\draw[->, thick] (root) -- (l1);
\draw[->, thick, red] (root) -- (r1) node[midway, above right, red] {route $y=10$};
\draw[->] (l1) -- (l2l);
\draw[->] (l1) -- (l2r);
...
\textbf{Step 1:} Compare $y=10$ at $m=4$.\\
$y=x$ is lower ($4 < 10$), so it stays.\\
$y=10$ is routed to right child.
};

\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west] at (4.5, -3) {
\textbf{Step 2:} Interval $[4, 8]$ midpoint $m=6$.\\
$y=x$ is lower ($6 < 10$), so it stays.\\
$y=10$ is routed to interval $[4, 6]$.
};

\end{tikzpicture}
\caption{Line Insertion Tree View. Inserting line $y=10$. At each node, the line with the lower value at the midpoint is stored, while the other is routed to a child. Red arrows highlight the insertion path.}
...
\node[draw, rectangle, minimum width=2.5cm] (l2r) at (-1.2,-4) {$[2, 4]$: $-$};
\node[draw, rectangle, minimum width=2.5cm] (r2l) at (1.2,-4) {$[4, 6]$: $y=10$};
\node[draw, rectangle, minimum width=2.5cm] (r2r) at (3.8,-4) {$[6, 8]$: $-$};
