...
Figure~\ref{fig:query-example} shows a query at $x=5$ following a single root-to-leaf path in the tree structure from the previous example.
...
% Result box - moved to avoid overlap
