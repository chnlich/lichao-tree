...
% Edges with labels
\draw[->, thick] (root) -- (l1);
\draw[->, thick, red] (root) -- (r1) node[midway, above right, red] {route $L_{new}$};
\draw[->] (l1) -- (l2l);
\draw[->] (l1) -- (l2r);
\draw[->, thick, red] (r1) -- (r2l) node[midway, above left, red] {route $L_{new}$};
\draw[->] (r1) -- (r2r);

% Explanation callouts
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west] at (4.5, -0.5) {
\textbf{Step 1:} At $[0,8]$, $m=4$:\\
$L_{st}(4)=4$, $L_{new}(4)=7$.\\
$y=x$ is lower, stays.\\
New line routed right ($L_{new}(l) > L_{st}(l)$).
};

\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west] at (4.5, -2.2) {
\textbf{Step 2:} At $[4,8]$, $m=6$:\\
$L_{st}(6)=5.6$, $L_{new}(6)=8$.\\
$y=0.6x+2$ is lower, stays.\\
New line routed left ($L_{new}(l) > L_{st}(l)$).
};

\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west] at (4.5, -4.0) {
