...
% Explanation callouts - repositioned with more space
\node[draw, dashed, rounded corners, inner sep=4pt, align=left, anchor=west, fill=white, fill opacity=0.9, text opacity=1, font=\scriptsize] at (4.0, 0) {
...
\node[draw, dashed, rounded corners, inner sep=4pt, align=left, anchor=west, fill=white, fill opacity=0.9, text opacity=1, font=\scriptsize] at (4.0, -2.0) {
\textbf{Step 2:} At $[4,8], m=6$\\
$L_{st}(6)=5.6, L_{new}(6)=8$\\
$y=0.6x+2$ lower, stays.\\
Route left to $[4,6]$.
};

\node[draw, dashed, rounded corners, inner sep=4pt, align=left, anchor=west, fill=white, fill opacity=0.9, text opacity=1, font=\scriptsize] at (4.0, -4.0) {
\textbf{Step 3:} At $[4,6]$, empty.\\
Store $L_{new}: y=0.5x+5$.\\
Recursion ends.
};
