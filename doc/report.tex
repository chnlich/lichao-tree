...
\node[draw, rectangle, minimum width=2.5cm] (r1) at (2.5,-2) {$[4, 8]$: $-$};
...
\draw[->] (l1) -- (l2l);
\draw[->] (l1) -- (l2r);
\draw[->, thick, red] (r1) -- (r2l) node[midway, above left, red] {store here};
\draw[->] (r1) -- (r2r);
...
\textbf{Step 2:} At $[4,8]$, node is empty.\\
Store $y=3x-8$ here? No, check $[4,6]$.\\
(New line wins on $[4,6]$, so route down).
};
