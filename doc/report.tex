...
Without loss of generality, assume $f_1$ dominates (achieves the lower value) on the majority subinterval $[m, r]$ where $m = (l+r)/2$. We designate $f_1$ as the \emph{representative} line for $[l, r]$\textemdash it is the optimal answer for any query $x \in [m, r]$.
