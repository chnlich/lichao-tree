...
The following community resources have contributed to the dissemination of Li-Chao tree techniques: CP-Algorithms (\url{https://cp-algorithms.com/geometry/li_chao_tree.html}), the Codeforces tutorial by I\_LOVE\_TIGER (\url{https://codeforces.com/blog/entry/51275}), and the KTH Algorithm Competition Template Library (KACTL, \url{https://github.com/kth-competitive-programming/kactl}).
...
\bibitem{lichao2012}
Li Chao.
\newblock Segment trees (in Chinese).
