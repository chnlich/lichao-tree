...
\midrule
$10^5$ & Random & 5 ms & 2 ms \\
$10^5$ & All on Hull & 17 ms & 15 ms \\
\midrule
$10^6$ & Random & 53 ms & 29 ms \\
$10^6$ & All on Hull & 516 ms & 654 ms \\
\midrule
$10^7$ & Random & 545 ms & 292 ms \\
$10^7$ & All on Hull & 13475 ms & 15296 ms \\
\bottomrule
\end{tabular}
\end{table}
...
$10^5$ & Random & Dynamic CHT & 2.23 & 0.35 & 2.58 \\
$10^5$ & Random & ZKW LICT & 2.34 & 0.59 & 2.93 \\
$10^5$ & All on Hull & LICT & 7.82 & 5.77 & 13.59 \\
$10^5$ & All on Hull & Dynamic CHT & 8.99 & 6.92 & 15.92 \\
$10^5$ & All on Hull & ZKW LICT & 5.19 & 1.90 & 7.09 \\
\midrule
$10^6$ & Random & LICT & 27.20 & 9.63 & 36.83 \\
$10^6$ & Random & Dynamic CHT & 23.47 & 3.60 & 27.08 \\
$10^6$ & Random & ZKW LICT & 27.15 & 6.39 & 33.55 \\
$10^6$ & All on Hull & LICT & 160.01 & 252.91 & 412.92 \\
$10^6$ & All on Hull & Dynamic CHT & 325.13 & 320.79 & 645.92 \\
$10^6$ & All on Hull & ZKW LICT & 78.52 & 55.21 & 133.74 \\
\midrule
$10^7$ & Random & LICT & 314.74 & 100.01 & 414.74 \\
$10^7$ & Random & Dynamic CHT & 229.47 & 45.58 & 275.06 \\
$10^7$ & Random & ZKW LICT & 322.09 & 77.96 & 400.05 \\
$10^7$ & All on Hull & LICT & 4720.22 & 5632.03 & 10352.25 \\
$10^7$ & All on Hull & Dynamic CHT & 7024.19 & 7008.35 & 14032.54 \\
$10^7$ & All on Hull & ZKW LICT & 1802.21 & 1598.80 & 3401.01 \\
\bottomrule
\end{tabular}
\end{table}

\subsubsection{Analysis of ZKW Implementation}
% TODO(chnlich): fix this.
We introduced an iterative, array-based Li Chao Tree (ZKW style) to compare against the dynamic pointer-based implementation. The results reveal a significant trade-off based on tree density:

\begin{itemize}
    \item \textbf{Sparse Cases (Random):} Initially, we hypothesized ZKW would be slower for sparse data. However, after optimizing the implementation to stop immediately upon encountering empty nodes (sentinel values), \textbf{ZKW LICT outperforms Standard LICT} even for sparse random inputs ($N=10^7$: 400ms vs 415ms total). The contiguous memory layout and lack of pointer-chasing overhead outweigh the theoretical benefits of the dynamic tree's minimal node creation. 
\end{itemize}

In conclusion, the \textbf{ZKW Li Chao Tree is the superior implementation across all tested regimes}, offering robust performance for both sparse and dense data distributions. The iterative structure combined with careful sentinel handling eliminates the traditional weaknesses of array-based trees.
...
\textbf{Implementation complexity.} We assess implementation complexity by the number of \emph{corner cases} requiring careful handling, the primary source of bugs under contest time pressure.

\begin{itemize}
\item \textbf{Dynamic CHT:} Despite compact code via \texttt{std::multiset}, the implementation must correctly handle: (1)~equal-slope (collinear) lines, (2)~cascading hull invalidation in both directions after insertion and (3)~boundary conditions at the hull endpoints. Each case is a potential source of subtle bugs.
\item \textbf{LICT:} The insertion logic reduces to two comparisons. No division, no intersection computation, no boundary cases.
\end{itemize}
