...
\midrule
$10^5$ & Random & LICT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^5$ & Random & Dynamic CHT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^5$ & All on Hull & LICT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^5$ & All on Hull & Dynamic CHT & $\cdot$ & $\cdot$ & $\cdot$ \\
\midrule
$10^6$ & Random & LICT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^6$ & Random & Dynamic CHT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^6$ & All on Hull & LICT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^6$ & All on Hull & Dynamic CHT & $\cdot$ & $\cdot$ & $\cdot$ \\
\midrule
$10^7$ & Random & LICT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^7$ & Random & Dynamic CHT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^7$ & All on Hull & LICT & $\cdot$ & $\cdot$ & $\cdot$ \\
$10^7$ & All on Hull & Dynamic CHT & $\cdot$ & $\cdot$ & $\cdot$ \\
\bottomrule
\end{tabular}
\end{table}
...
\bibitem{lichao2012}
Li, Chao.
\newblock \begin{CJK}{UTF8}{gbsn}线段树\end{CJK} [Segment trees].
\newblock Lecture slides, Hangzhou Xuejun High School, China, 2012.
\newblock Available at \url{https://github.com/chnlich/lichao-tree/blob/main/doc/slides.ppt}.
...
\newblock \emph{Journal of Computer and System Sciences}, 38(1):86 to 124, 1989.

\bibitem{bentley1977}
Bentley, J.L.
\newblock Solutions to Klee's rectangle problems.
\newblock Unpublished manuscript, Carnegie Mellon University, 1977.

\bibitem{renyi1963}
R\'{e}nyi, A. and Sulanke, R.
\newblock \"{U}ber die konvexe H\"{u}lle von $n$ zuf\"{a}llig gew\"{a}hlten Punkten.
\newblock \emph{Zeitschrift f\"{u}r Wahrscheinlichkeitstheorie und verwandte Gebiete}, 2(1):75 to 84, 1963.
