...
\midrule
$10^5$ & Random & LICT & 2.19 & 0.95 & 3.14 \\
$10^5$ & Random & Dynamic CHT & 2.19 & 0.39 & 2.58 \\
$10^5$ & Random & ZKW LICT & 2.40 & 2.42 & 4.81 \\
$10^5$ & All on Hull & LICT & 8.23 & 5.71 & 13.94 \\
$10^5$ & All on Hull & Dynamic CHT & 8.85 & 7.18 & 16.03 \\
$10^5$ & All on Hull & ZKW LICT & 6.32 & 1.47 & 7.79 \\
\midrule
$10^6$ & Random & LICT & 27.12 & 9.53 & 36.66 \\
$10^6$ & Random & Dynamic CHT & 24.00 & 3.49 & 27.49 \\
$10^6$ & Random & ZKW LICT & 27.49 & 85.36 & 112.85 \\
$10^6$ & All on Hull & LICT & 172.03 & 214.18 & 386.21 \\
$10^6$ & All on Hull & Dynamic CHT & 289.25 & 324.14 & 613.39 \\
$10^6$ & All on Hull & ZKW LICT & 144.42 & 86.29 & 230.71 \\
\midrule
$10^7$ & Random & LICT & 315.94 & 100.15 & 416.09 \\
$10^7$ & Random & Dynamic CHT & 231.65 & 43.77 & 275.43 \\
$10^7$ & Random & ZKW LICT & 318.39 & 1359.40 & 1677.79 \\
$10^7$ & All on Hull & LICT & 4557.96 & 5475.32 & 10033.28 \\
$10^7$ & All on Hull & Dynamic CHT & 7003.07 & 6616.61 & 13619.68 \\
$10^7$ & All on Hull & ZKW LICT & 2327.35 & 1355.73 & 3683.08 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{Dense Cases (All on Hull):} The ZKW implementation is \textbf{2.6x faster} than standard LICT ($N=10^7$). This massive speedup stems from better cache locality (contiguous memory), elimination of pointer-chasing overhead, and zero memory allocation during insertion. Since the "All on Hull" case forces the tree to be fully populated, the dynamic implementation's sparsity optimization provides no benefit, making the raw efficiency of the array-based approach superior.
    \item \textbf{Sparse Cases (Random):} Conversely, the ZKW implementation is \textbf{4x slower} than standard LICT. Our analysis shows that for random inputs, the standard dynamic tree remains extremely sparse, effectively terminating queries near the root (depth $\sim$1) due to the random lines quickly dominating the range. In contrast, the ZKW implementation's power-of-two padding shifts the tree structure, causing relevant data to cluster in deeper subtrees. Debugging revealed that even with early exit optimizations, ZKW queries visit an average of \textbf{5.2 nodes} per query, which is significantly more than the standard implementation, leading to the observed performance gap.
\end{itemize}

This suggests that ZKW LICT is the optimal choice when the coordinate range is small or the tree is expected to be dense, while the dynamic implementation is robust for large ranges with sparse data.
