...
% Level 1 nodes
\node[draw, rectangle, fill=blue!10, minimum width=2.2cm] (l1) at (-2.0,-2.0) {$[0, 4]$: $y=2x$};
\node[below=0.1cm of l1] {\scriptsize $m=2$};
\node[draw, rectangle, fill=blue!10, minimum width=2.2cm] (r1) at (2.0,-2.0) {$[4, 8]$: $y=0.6x+2$};
\node[below=0.1cm of r1] {\scriptsize $m=6$};

% Level 2 nodes
\node[draw, rectangle, minimum width=1.5cm] (l2l) at (-3.0,-4.0) {$[0, 2]$: $-$};
\node[draw, rectangle, minimum width=1.5cm] (l2r) at (-1.0,-4.0) {$[2, 4]$: $-$};
\node[draw, rectangle, fill=red!10, minimum width=1.5cm] (r2l) at (1.0,-4.0) {$[4, 6]$: $L_{new}$};
\node[below=0.1cm of r2l] {\scriptsize $m=5$};
\node[draw, rectangle, minimum width=1.5cm] (r2r) at (3.0,-4.0) {$[6, 8]$: $-$};

% Edges with labels
\draw[->, thick] (root) -- (l1);
\draw[->, thick, red] (root) -- (r1) node[midway, right, red, font=\tiny, xshift=2pt] {route};
\draw[->] (l1) -- (l2l);
\draw[->] (l1) -- (l2r);
\draw[->, thick, red] (r1) -- (r2l) node[midway, left, red, font=\tiny, xshift=-2pt] {route};
\draw[->] (r1) -- (r2r);

% Explanation callouts - properly spaced
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west, fill=white, fill opacity=0.95, font=\scriptsize] at (5.0, 0.5) {
...
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west, fill=white, fill opacity=0.95, font=\scriptsize] at (5.0, -1.5) {
...
\node[draw, dashed, rounded corners, inner sep=5pt, align=left, anchor=west, fill=white, fill opacity=0.95, font=\scriptsize] at (5.0, -3.5) {
...
% Level 1 nodes
\node[draw, rectangle, fill=green!10, minimum width=2.2cm] (l1) at (-2.0,-2.0) {$[0, 4]$: $y=2x$};
\node[below=0.1cm of l1] {\scriptsize $m=2$};
\node[draw, rectangle, fill=blue!10, minimum width=2.2cm] (r1) at (2.0,-2.0) {$[4, 8]$: $y=0.6x+2$};
\node[below=0.1cm of r1] {\scriptsize $m=6$};

% Level 2 nodes
\node[draw, rectangle, fill=yellow!20, minimum width=1.5cm] (l2l) at (-3.0,-4.0) {$[0, 2]$: $-$};
\node[draw, rectangle, minimum width=1.5cm] (l2r) at (-1.0,-4.0) {$[2, 4]$: $-$};
\node[draw, rectangle, minimum width=1.5cm] (r2l) at (1.0,-4.0) {$[4, 6]$: $L_{new}$};
\node[draw, rectangle, minimum width=1.5cm] (r2r) at (3.0,-4.0) {$[6, 8]$: $-$};

% Query path highlighted
\draw[->, very thick, blue] (root) -- (l1) node[midway, left, font=\tiny] {$x=1 \le 4$};
\draw[->, very thick, blue] (l1) -- (l2l) node[midway, left, font=\tiny] {$x=1 \le 2$};

% Result box
\node[draw, thick, fill=white, rounded corners, align=left, font=\scriptsize] at (4.0, -1.8) {
...
\node[below=0.2cm of l2l, red, font=\scriptsize\bfseries] {Target $x=1$};
